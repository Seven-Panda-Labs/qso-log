...
- ADIF import and export, including the DXCC entity a log already recorded.
- Statistics: contacts, stations, days on air, countries worked, and a breakdown by band and mode.
